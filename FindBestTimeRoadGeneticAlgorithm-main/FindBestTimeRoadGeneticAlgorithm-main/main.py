...
genePool = readJsonV2("../sample_frequency.csv")
dList = getDistanceList('distanceMatrix.csv')
durList = getDistanceList('durationMatrix.csv')
TAGS = []
...
x = type8(int(nPeople), int(budget), int(duration), epochs, genePool, dList, durList, evaluateV1, 0.1, 2000, TAGS)
showResults(x, nPeople, dList, 1, 'type8', durList)
result = sendResults(x, nPeople, dList, 'type8', durList)
